-- PG cache tables for PE and PM results.
-- Stores pre-computed BQ results to avoid hitting BQ on repeat requests.
-- Cleared daily by the sync job and on plan parameter/decision changes.
...
-- Generic small-result cache for filter endpoints
